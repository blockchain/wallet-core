...
class MainActivity : AppCompatActivity() {
    ...
    private val seedPhrase = "agree auto mandate shaft latin blade arrive card betray expand fog vanish"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        // Bitcoin example
        val coinBtc: CoinType = CoinType.DIGITALGOLD
        // Get the default address
        val addressBtc = wallet.getAddressForCoin(coinBtc)
        showLog("Default DGLD address: \n$addressBtc")
        ...
        showLog("Signed DGLD transaction: \n${signedTransaction?.toHexString()}")
    }
